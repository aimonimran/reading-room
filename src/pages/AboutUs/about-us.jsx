      ...
      <div className="row about-us">
        ...
        <div className="col-sm-12 col-lg-6 order-sm-2 order-lg-1 about-us-body">
          ...
          <h3 className="about-us-paragraph-one my-3">
            ...
            provides you books to read but also allows your inner creative self
            to dump ideas with a distinctly amazing vibe. It provides a safe
            forum to people to put their writing abilities to test and receive
            honest reviews on it.
          </h3>
        </div>
      </div>
    </div>
